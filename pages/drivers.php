...
<div class="latestcars">
	<h1 class="text-center">&bullet; LATEST   DRIVERS &bullet;</h1>
...
<br>
 ...
 include "baglan.php";
 $stmt="<div class=\"row\">";
 $query=$db->query("SELECT hizmetveren.ad,hizmetveren.soyAd,hizmetveren.telefon,hizmetveren.hvProfil,arac.aracTuru,arac.aracMarka,arac.aracModel,arac.aracFiyat FROM hizmetveren,arac where hizmetveren.plaka=arac.plaka",PDO::FETCH_ASSOC);
   
 if($query->rowCount()){
	 foreach($query as $row){
		 $stmt.="<div class=\"col-xs-12 col-sm-6 col-md-4 col-lg-3\">
		 <div class='txthover'>	 
		 		<img src=\"data:image/jpeg;base64,".base64_encode( $row['hvProfil'] )."\"/>
						<div class='txtcontent'>
							...
							<div class='simpletxt'>
								<h3 class='name'>".$row['ad']."&nbsp".$row['soyAd']."</h3>
								<p>'".$row['telefon']."<br>
								".$row['aracTuru']."<br>
								".$row['aracMarka']."&nbsp".$row['aracModel']."</p>
	 							<h4>".$row['aracFiyat']."  &#8378;</h4>
